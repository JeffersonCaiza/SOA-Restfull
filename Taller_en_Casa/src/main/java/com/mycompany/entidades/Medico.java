...
@NamedQueries({
    ...
    @NamedQuery(name = "Medico.findByDirecccion", query = "SELECT m FROM Medico m WHERE m.direcccion = :direcccion"),
...
public class Medico implements Serializable {
    ...
    public Medico(Integer id, String nombre, String apellido, String edad, String telefono, String email, String direcccion, String especialidad, String fechaIngreso, String foto) {
        this.id = id;
        this.nombre = nombre;
